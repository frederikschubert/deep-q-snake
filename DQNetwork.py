...
class DQNetwork:
	...
	def __init__(self, actions, input_shape, alpha = 0.1, gamma = 0.99, dropout_prob = 0.1, load_path = '', logger=None):
		...
		self.model.add(Conv2D(32, (2, 2), padding="valid", strides=(2, 2), data_format="channels_first"))
		self.model.add(Activation('relu'))

		self.model.add(BatchNormalization(axis=1))
		self.model.add(Conv2D(64, (2, 2), padding="valid", strides=(2, 2), data_format="channels_first"))
		self.model.add(Activation('relu'))

		self.model.add(BatchNormalization(axis=1))
		self.model.add(Conv2D(64, (3, 3), padding="valid", strides=(2, 2), data_format="channels_first"))
		self.model.add(Activation('relu'))
	...
	def train(self, batch):
		...
		history = self.model.fit(x_train, t_train, batch_size=32, epochs=1)
